...
@section('home')    
    ...
    <div class="slider-area">
        <div class="owl-carousel owl-theme banner-slider">
            <div class="item">
                <img src="{{ asset('userFrontend/assets/img/slider/slider1.jpg')}}" alt="">
            </div>
            <div class="item">
                <img src="{{ asset('userFrontend/assets/img/slider/slider2.jpg')}}" alt="">
            </div>
            <!-- <div class="item">
                        ...
                        <marquee behavior="scroll" direction="Up" onmouseover="this.stop();" onmouseout="this.start();">
                            <div class="each-notice">
                                <div class="notice-date">
                                    <div class="n-month">23 <span>Jun</span></div>
                                    <div class="n-year">2022</div>
                                </div>
